...
for instrumento in saxofon fagot trompeta trompa violin viola chelo contrabajo bateria xilofono director; do
	...
	chown $instrumento /orquesta/$NOMBREOBRA/$instrumento.dat
	chown $instrumento /orquesta/$NOMBREOBRA/partitura_$instrumento.dat
	chgrp $instrumento /orquesta/$NOMBREOBRA/$instrumento.dat
	chgrp $instrumento /orquesta/$NOMBREOBRA/partitura_$instrumento.dat

	echo "$(id -u $instrumento)" >> /orquesta/$NOMBREOBRA/$instrumento.dat
	echo "$(id -g $instrumento)" >> /orquesta/$NOMBREOBRA/$instrumento.dat
done
